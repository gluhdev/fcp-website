...
export default function SportsEquipmentPage() {
  ...
  const handleGetQuote = (product?: string) => {
    const subject = product ? `Quote Request: ${product}` : 'Quote Request: Sports Equipment';
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            >
              <h1 style={{
                ...
                <EditableText
                  path="pages.sportsEquipment.hero.title"
                  defaultValue="Custom Sports Equipment"
                  as="span"
                />
              </h1>
              <p style={{
                ...
                <EditableText
                  path="pages.sportsEquipment.hero.description"
                  defaultValue="High-quality custom sports equipment for athletes, fitness enthusiasts, and sports teams. Built to perform."
                  as="span"
                  multiline
                />
              </p>
                ...
                >
                  ...
                  <div style={{ padding: isMobile ? '1.5rem' : '2rem' }}>
                    <h3 style={{
                      ...
                      <EditableText
                        path={`pages.sportsEquipment.categories.${category.id}.title`}
                    ...
                    <p style={{
                      ...
                      <EditableText
                        path={`pages.sportsEquipment.categories.${category.id}.description`}
        ...
        <section style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              <EditableText
                path="pages.sportsEquipment.cta.title"
                defaultValue="Custom Sports Equipment"
                as="span"
              />
            </h2>
            <p style={{
              ...
              <EditableText
                path="pages.sportsEquipment.cta.description"
                defaultValue="Work with our team to create custom branded sports equipment for your team or business"
                as="span"
                multiline
              />
            </p>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Premium Sports Equipment Solutions
          </p>
        </div>
      </footer>
    </>
