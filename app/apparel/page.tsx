...
export default function ApparelPage() {
  ...
  const handleGetQuote = (product?: string) => {
    const subject = product ? `Quote Request: ${product}` : 'Quote Request: Sports Apparel';
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            >
              <h1 style={{
                ...
                <EditableText
                  path="pages.apparel.hero.title"
                  defaultValue="Sports Apparel"
                  as="span"
                />
              </h1>
              <p style={{
                ...
                <EditableText
                  path="pages.apparel.hero.description"
                  defaultValue="From gym apparel to hats, hoodies, and sweatshirts, we provide high quality custom apparel solutions for all athletic needs."
                  as="span"
                  multiline
                />
              </p>
                ...
                >
                  ...
                  <div style={{
                    ...
                    <h3 style={{
                      ...
                      <EditableText
                        path={`pages.apparel.categories.${category.id}.title`}
                    ...
                    <p style={{
                      ...
                      <EditableText
                        path={`pages.apparel.categories.${category.id}.description`}
        ...
        <section style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              <EditableText
                path="pages.apparel.cta.title"
                defaultValue="Custom Sports Apparel"
                as="span"
              />
            </h2>
            <p style={{
              ...
              <EditableText
                path="pages.apparel.cta.description"
                defaultValue="Work with our design team to create unique apparel for your team or brand"
                as="span"
                multiline
              />
            </p>
